...
public class ExchangeRateDatabase {
    ...
    /**
     * Gets currency names, made it static so that it can be accessed in ExchangeRateWorker class
     ...
     */
    public synchronized double convert(double value, String currencyFrom, String currencyTo) {
